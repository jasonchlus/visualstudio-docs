...
<a name="trace"></a>8. Record your actions to reproduce the issue.
...
4.   ![Record your actions](../ide/media/feedback-recording.png)
...
9. Review the attached files and upload additional files if you believe it would help diagnose the issue.

    ![Attached files](../ide/media/feedback-attachments.png)
    *Only Microsoft engineers can see the attached files*

10. The last step is to hit the **Submit** button. Submitting the report will send it directly into the internal Visual Studio bug reporting system awaiting triage.
